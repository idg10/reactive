...
{
    [TestClass]
    public class WindowsThreadPoolSchedulerTest
    {
        [TestMethod]
        public void Schedule_ArgumentChecking()
        {
            ReactiveAssert.Throws<ArgumentNullException>(() => WindowsThreadPoolScheduler.Instance.Schedule(42, default));
            ReactiveAssert.Throws<ArgumentNullException>(() => WindowsThreadPoolScheduler.Instance.Schedule(42, DateTimeOffset.Now, default));
            ReactiveAssert.Throws<ArgumentNullException>(() => WindowsThreadPoolScheduler.Instance.Schedule(42, TimeSpan.Zero, default));
        }
